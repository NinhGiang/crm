...
def generate_video(filepath, usermedia, albumID, mediaID):
    ...
    crop_count = process_video(frames_list, results_list, albumID, mediaID)
    print("Crop count is" + str(crop_count))
...
if __name__ == "__main__":
    ...
    model = torch.hub.load(
        "ultralytics/yolov5", "custom", path=str(os.getcwd())+'/last_result.pt', force_reload=True, source='github', autoshape=True
